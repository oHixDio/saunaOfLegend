...
namespace Cainos.CustomizablePixelCharacter
{
    ...
    public class PixelCharacter : MonoBehaviour
    {
        ...
        //これらのパラメータは実行時にのみ変更されるべきもので、主にアニメーターパラメータのラッパーです。
        #region RUNTIME
        ...
        //1なら突き,0なら振り
        [ExposeProperty]
        public AttackActionType AttackAction                                                //攻撃モーションの突きか振りかの変更
        {
        ...
        [ExposeProperty]
        public int Facing　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　//顔の向きを変えるメソッド
        {
            get { return facing; }
            set
            {
        ...
        [ExposeProperty]
        public bool IsAttacking                                           //攻撃中ならオンにする。(基本的には継続攻撃武器でオン)
        {
        ...
        [ExposeProperty]
        public float MovingBlend　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　//歩きアニメーション変更メソッド
        {
            get
            {
                return movingBlend;
